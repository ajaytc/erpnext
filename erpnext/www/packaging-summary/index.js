            ...
            callback: function (r) {
                if (!r.exc) {
                    ...
                    frappe.msgprint({
                        ...
                        indicator: 'green',
                        message: __('Packaging Order ' + "{{packOrder.name}}'s" + ' payment proof submitted successfully')
                    });
            ...
            callback: function (r) {
                if (!r.exc) {
                    ...
                    frappe.msgprint({
                        title: __('Notification'),
                        indicator: 'green',
                        message: __('Packaging order ' + "{{packOrder.name}}" + ' summary created successfully')
                    });
                    ...
                    frappe.msgprint({
                        title: __('Notification'),
                        indicator: 'red',
                        message: __('Packaging order ' + "{{packOrder.name}}" + ' summary created Failed')
                    });
                }
            }
        })
