            ...
            callback: function (r) {
                if (!r.exc) {
                    ...
                    frappe.msgprint({
                        ...
                        indicator: 'green',
                        message: __('Trimming Order ' + "{{trimOrder.name}}'s" + ' payment proof submitted successfully')
                    });
            ...
            callback: function (r) {
                if (!r.exc) {
                    ...
                    frappe.msgprint({
                        title: __('Notification'),
                        indicator: 'green',
                        message: __('Trimming order ' + "{{trimOrder.name}}" + ' summary created successfully')
                    });
                    ...
                    frappe.msgprint({
                        title: __('Notification'),
                        indicator: 'red',
                        message: __('Trimming order ' + "{{trimOrder.name}}" + ' summary created Failed')
                    });
                }
            }
        })
